...
OCV_HASH=b1cf5501233405de3ea5926d1d688e421b337458
...
OCV_FLAGS="-D CMAKE_BUILD_TYPE=RELEASE -D BUILD_SHARED_LIBS=OFF \
           ...
           -D CV_ENABLE_INTRINSICS=OFF -D WITH_ITT=OFF -D WITH_CAROTENE=OFF \
           -D BUILD_PROTOBUF=OFF -D WITH_PROTOBUF=OFF -D WITH_QUIRC=OFF"
OPENCV_EXTRA_FLAGS=
